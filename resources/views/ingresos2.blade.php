            ...
            <div class="d-flex flex-column gap-3 w-100">
                ...
                <div
                    ...
                    <div class="d-flex w-100 py-2 justify-content-between flex-wrap">
                        <span style="font-size: small;" class="fw-semibold">{{
                            \Carbon\Carbon::parse($ingreso['created_at'])->timezone('America/Santiago')->format('d/m/Y
                            H:i') }}
                        </span>
