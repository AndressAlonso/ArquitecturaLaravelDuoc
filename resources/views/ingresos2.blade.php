        ...
        <div id="DatosServicioClinico" class="flex-fill d-flex flex-column justify-content-center">
            ...
            <div id="eDesde" class="d-flex flex-column gap-2">
                ...
                <div class="w-100 d-flex gap-1 justify-content-end px-2 align-items-end">
                    <span>En Total</span> :<span>{{ collect($servicioClinicoarray['ropas'])->sum('pivot.cantidad') }}</span>
                    ...
                    <div
                        ...
                        <div class="d-flex w-100 py-2 justify-content-between flex-wrap">
                            <span style="font-size: small;"
                                class="fw-semibold">{{ \Carbon\Carbon::parse($ingreso['created_at'])->format('d/m/Y') }}</span>

                            <div>
                                <span class="fw-semibold">Total Prendas:
                                                    ...
                                                    @if ($ropa['pivot']['estado'] == 'sucia')
                                                        <div class="d-flex justify-content-center gap-3">
                                                            <div class="d-flex flex-column text-start gap-0">
                                                                <span>{{ $ropa['tipo'] }}</span>
                                                                <div>
                                                                    <span class="text-success">{{ $ropa['pivot']['cantidad'] }}
                                                                        Unidades</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @if ($ropa['pivot']['estado'] == 'limpia')
                                                        <div class="d-flex justify-content-center gap-3">
                                                            <div class="d-flex flex-column text-start gap-0">
                                                                <span>{{ $ropa['tipo'] }}</span>
                                                                <div>
                                                                    <span class="text-black-50">{{ $ropa['pivot']['cantidad'] }}
                                                                        Unidades</span>
                                                                </div>
                                                            </div>
                                                        </div>
