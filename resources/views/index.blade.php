...
<body data-bs-theme="light">
  ...
  <nav class="navbar border-bottom border-body navbar-expand-lg">
    <div class="container-fluid">
      ...
      <ul class="dropdown-menu">
        <li>
        <a class="dropdown-item" href="{{ route('admin.mostrarTabla', 'ropa') }}">Ropas</a>
        </li>
        <li>
        <a class="dropdown-item" href="{{ route('admin.mostrarTabla', 'servicio_clinico') }}">Tipos de Servicio
        Clinicos</a>
        </li>
        <li>
        <a class="dropdown-item" href="{{ route('admin.mostrarTabla', 'servicio_clinico_ropa') }}">Servicios
        Clinicos</a>
        </li>
        <li>
